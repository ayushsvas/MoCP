...
#Monte carlo jumps 
#I give 50 trials to each point(q1,q2), and each trial runs for 10000 steps i.e. time for a trajectory to reach either A or B. It is possible to reaches nowhere. 
@jit(nopython=True)
def pot(Q1,Q2):
